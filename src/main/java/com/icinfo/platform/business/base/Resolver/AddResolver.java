 ...
 */
public class AddResolver implements IResolver {
    ...
    public String resolver(Map<String, Object> map) throws Exception {
        ...
        int sum = Integer.sum(paramA == null ? 0 : Integer.valueOf(paramA.toString()), paramB == null ? 0 : Integer.valueOf(paramB.toString()));
